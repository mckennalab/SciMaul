...
class ResolvedDimensionTest extends FlatSpec with Matchers {
  "ResolvedDimension" should "get sorted correctly" in {
    ...
    val dim1 = ResolvedDimension("dim1", ReadPosition.Index1, 0, 10, SequenceType.Index, Array[Sequence](), 1, true, "fake_mask", 0)
    val dim2 = ResolvedDimension("dim2", ReadPosition.Index1, 10, 10, SequenceType.Index, Array[Sequence](), 1, true, "fake_mask", 0)
  ...
  "ResolvedDimension" should "not mis-sort sequences on different reads" in {
    ...
    val dim1 = ResolvedDimension("dim1", ReadPosition.Read1, 0, 10, SequenceType.Index, Array[Sequence](), 1, true, "fake_mask", 0)
    val dim2 = ResolvedDimension("dim2", ReadPosition.Index1, 10, 10, SequenceType.Index, Array[Sequence](), 1, true, "fake_mask", 0)
